"""Pytest wrapper launching AXI4-Lite cocotb tests for parameterized designs."""
...
def test_axi4lite_parameterized_smoke(tmp_path: Path, reg_count: int, bank_count: int) -> None:
    """Compile AXI4-Lite parameterized variants and execute the cocotb smoke test."""
    ...
    logging.info("Running AXI4-Lite parameterized test: %s (regs=%d, banks=%d)", top_name, reg_count, bank_count)
