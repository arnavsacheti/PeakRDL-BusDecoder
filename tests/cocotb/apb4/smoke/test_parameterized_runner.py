"""Pytest wrapper launching APB4 cocotb tests for parameterized designs."""
...
def test_apb4_parameterized_smoke(tmp_path: Path, reg_count: int, bank_count: int) -> None:
    """Compile APB4 parameterized variants and execute the cocotb smoke test."""
    ...
    logging.info("Running APB4 parameterized test: %s (regs=%d, banks=%d)", top_name, reg_count, bank_count)
